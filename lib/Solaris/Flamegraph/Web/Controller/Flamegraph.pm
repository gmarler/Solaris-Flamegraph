package Solaris::Flamegraph::Web::Controller::Flamegraph;
use Moose;
use DateTime   qw();
use IO::Scalar qw();
use File::Temp qw();
...
Solaris::Flamegraph::Web::Controller::Flamegraph - Catalyst Controller
...
sub base :Chained('/') :PathPart('flamegraph') :CaptureArgs(0) {
  ...
  # Solaris::Flamegraph::Web::Schema.pm
